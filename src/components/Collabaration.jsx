        ...
        <div className="container lg:flex">
            <div className="max-w-[25rem]">
                <h2 className='h2 mb-4 md:mb-8'>
                    AI Chat App for seamleass collaboration 
                </h2>
                <ul className='max-w-[22rem] mb-10  md:mb-14'>
                    {collabContent.map((item)=>(
                        <li className='mb-3 py-3' key={item.id}><div className="flex items-center">
            ...
            <div className="lg:ml-auto xl:w-[38rem] ">
                ...
                <p className='body-2 mb-8 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto mt-4'>{collabText}</p>

            <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
<div className="flex w-[15rem] aspect-square border rounded-full m-auto  border-n-6 ">
...
<ul>
   {collabApps.map((app,index)=>(
    <li key={index} className={`absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] origin-bottom rotate-${index *45}`}>
       ...
       <img src={app.icon} className='m-auto' alt="app" height={app.width } width={app.height} />
       </div>
    </li>
   ))}
